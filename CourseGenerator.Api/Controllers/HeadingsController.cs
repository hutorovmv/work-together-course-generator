...
//        private readonly IHeadingServiceUpgrade _headingService;
//        private string UserId => HttpContext.User
...
//            IHeadingServiceUpgrade headingService)
//        {
//            _mapper = mapper;
...
//            OperationInfo result = await _headingService.CreateAsync(UserId, headingDto);
//            if (result.Succeeded)
...
//                .CreateLocalAsync(UserId, headingLangDto);
//            if (result.Succeeded)
//                return StatusCode(StatusCodes.Status201Created);
...
//            OperationInfo result = await _headingService
//                .UpdateLocalAsync(UserId, headingLangDto);
//            if (result.Succeeded)
//                return NoContent();
...
//        {
//            HeadingDTO headingDto = await _headingService.GetAsync(UserId, id);
...
//            string lang)
//        {
//            IEnumerable<HeadingLangDTO> headingLangDtos = null;//_headingService
...
//            string lang)
//        {
//            IEnumerable<HeadingLangDTO> headingLangDtos = null;//await _headingService
